				...
				<ScrollView>
					{
						...
						<ImageBackground 
							source={{ uri: 'https://images.igdb.com/igdb/image/upload/t_cover_big_2x/'+this.state.dataSource.artworks[0].image_id+'.jpg'}}
							style={{width: '100%',  }} >
							<SingleTop>
								<Image 
							...
							<SingleTop style={{backgroundColor: 'rgba(0,0,0,0.1)',  }}>
								<Image 
									source={{ uri: 'https://images.igdb.com/igdb/image/upload/t_cover_big_2x/'+this.state.dataSource.cover.image_id+'.jpg' }} 
									style={{ width: 150, height: 200, resizeMode: 'contain' }}
								/>
